...
from OnsetOffsetDetection_v4.lightning_module import OnsetOffsetLightningModule

DEFAULT_DATASET_ROOT = Path("/mnt/archive/GTSinger/English")
DEFAULT_OUTPUT_DIR = REPO_ROOT / "OnsetOffsetDetection_v4" / "eval_outputs"


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate OnsetOffsetDetection_v4.")
