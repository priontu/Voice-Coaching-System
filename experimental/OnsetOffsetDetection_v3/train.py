...
from OnsetOffsetDetection_v3.lightning_module import OnsetOffsetLightningModule, OnsetOffsetTrainingConfig
from OnsetOffsetDetection_v3.model import CoupledModelConfig

DEFAULT_DATASET_ROOT = Path("/mnt/archive/GTSinger/English")
DEFAULT_OUTPUT_DIR = REPO_ROOT / "OnsetOffsetDetection_v3" / "runs" / "default"


def main() -> None:
    parser = argparse.ArgumentParser(description="Train OnsetOffsetDetection_v3 (Onsets & Frames coupling).")
    ...
    model_config = CoupledModelConfig(
