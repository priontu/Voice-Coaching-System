...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run PitchExtraction_v1 on a GTSinger subset.")
    ...
    parser.add_argument("--group-contains", default="Control_Group")
