...
from OnsetOffsetDetection_v5.lightning_module import OnsetOffsetLightningModule

DEFAULT_DATASET_ROOT = Path("/mnt/archive/GTSinger/English")
DEFAULT_OUTPUT_DIR = REPO_ROOT / "OnsetOffsetDetection_v5" / "eval_outputs"


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate OnsetOffsetDetection_v5.")
